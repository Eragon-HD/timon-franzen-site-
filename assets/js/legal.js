...
(() => {
  const EN = {
    ...
    lg_addr: "[Street and number]<br />[Postcode Town]",
    lg_email_l: "Email:",
    lg_phone: "Phone: [optional]",
    lg_vat: "Not VAT-registered (turnover below CHF 100,000). Once VAT-registered, add the UID (CHE number) here.",
